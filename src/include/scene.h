...
#ifndef SRC_INCLUDE_SCENE_H_
#define SRC_INCLUDE_SCENE_H_
...
class UserDevice {
 ...
 public:
  ...
  inline UserDevice(std::string new_key, Transform *transform) {
    key = new_key;
    trans = transform;
    trns_flag = true;
  }
  ...
  // Transforms
  inline void set_transform(Transform *transform) {
    trans = transform;
    trns_flag = true;
  }
...
class SceneData {
 ...
 public:
  ...
  inline void set_transform(Transform *trns) {
...
class Scene {
 ...
 public:
  ...
  inline SceneData* get_scene(unsigned int i) {
